...
def home():
    if request.method == "POST":
        ...
        mute_audio = request.form.get("mute_audio", "0")  # Default to "0" if not provided
        mute_video = request.form.get("mute_video", "0")  # Default to "0" if not provided
